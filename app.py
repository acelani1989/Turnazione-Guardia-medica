...
st.markdown("""
    ...
    /* Nasconde footer, header e scritte di stato (i "None" verdi) */
    footer, header, .stDeployButton {visibility: hidden;}
    [data-testid="stElementToolbar"] {display: none;}
    .stAlert, .st-emotion-cache-1ghh6y0, .st-emotion-cache-1wivap2, .st-emotion-cache-zt5igj { display: none !important; }
    </style>
...
# --- 5. INTERFACCIA: GENERA -> SCHEMA -> PDF ---
st.markdown(f"### TURNAZIONE PCA PORTO EMPEDOCLE - {mese_sel}")

# TASTO GENERA SEMPRE IN ALTO
